...
urlpatterns = [
    ...
    path('google/login/', google_auth_views.google_oauth_login, name='google_oauth_login'),
    path('google/callback/', google_auth_views.google_oauth_callback, name='google_auth_callback'),
