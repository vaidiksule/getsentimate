from mongoengine import Document, StringField, IntField, FloatField, DateTimeField, BooleanField, ListField, ReferenceField, URLField, DictField, EmailField
...
class MongoUser(Document):
    ...
    password = StringField(max_length=128, required=False)  # Django hashed password (optional for OAuth users)
    ...
    google_email = EmailField(sparse=True)  # Google email (may differ from primary email)
